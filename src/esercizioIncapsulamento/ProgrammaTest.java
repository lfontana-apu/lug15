...
public class ProgrammaTest {
	...
	public static void main(String[] args) {
		...
		while(!dataFisicamenteValida) {
			...
			inputValido = false;
			while (!inputValido) {
			System.out.println("Inserisci l'anno d'inizio (es.2026)");
			...
			inputValido = false;
			while (!inputValido){
			System.out.println("Inserisci il mese d'inizio (1-12)");
			...
			inputValido = false;
			while (!inputValido){
			System.out.println("Inserisci il giorno d'inizio (1-31)");
			...
			inputValido = false;
			while (!inputValido){
			System.out.println("Inserisci l'ora d'inizio (0-23)");
			...
			inputValido = false;
			while (!inputValido){
			System.out.println("Inserisci il minuto d'inizio (0-59)");
			...
			if (!dataFisicamenteValida) {
				System.out.println("[ATTENZIONE] La data inserita non esiste (es. Febbraio ha meno giorni). Reinserisci i dati.");
			}
		}
