...
public class Camicia {
	...
	// costruttore personalizzato: riceve argomenti nelle parentesi tonde, come un metodo
	...
	// creando un costruttore personalizzatom, va rigenerato quello predefinito:
	...
	public void setAcquistate(int acquistate) {
		// regola: almeno una acquistate e al massimo quante ce ne sono disponibili
		boolean ancora = true;
		...
		do {
			if (acquistate > 0 && acquistate <= getDisponibili()) { // getDisponibili() perchè disponibili è private, e l'unico private accessibile direttamente è quello che dà il nome al setter
				...
				System.out.print("Occorre acquistate almeno una camicia e al massimo " + getDisponibili() + "; reinserisci il valore");
